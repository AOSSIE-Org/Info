...
* Follow the CONTRIBUTING.md file of the repo to which you are contributing.
  - If the repo does not have a CONTRIBUTING.md file, then follow the recommendations in the [standard CONTRIBUTING.md file](https://github.com/AOSSIE-Org/Template-Repo/blob/main/CONTRIBUTING.md).
